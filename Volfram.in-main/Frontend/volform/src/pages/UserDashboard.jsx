...
function UserDashboard() {
  ...
  useEffect(() => {
    ...
    Promise.all([requirementsAPI.getMine(), chatbotLeadsAPI.getMine()])
      .then(([requirementData, chatbotData]) => {
