  ...
  return (
    <>
      ...
      >
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="lg:hidden mobile-menu-enter bg-white/95 backdrop-blur-md border-t border-slate-200 px-6 pb-6 pt-4 shadow-lg absolute w-full left-0 top-full">
